...
LOGIN_REDIRECT_URL = '/speech/home/'  # Or whatever your main page is


# Optional: add this if not using APP_DIRS in TEMPLATES
TEMPLATES = [
    {
...
SECRET_KEY = 'django-insecure-n0h=gd*)65f#j(jbvltcw1=)m&+5=lk62*)##q=uad-)q110@f'
...
# In case you want to add custom static directories
STATICFILES_DIRS = [
